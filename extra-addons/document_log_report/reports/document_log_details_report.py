...
class DocumentLogDetailsReport(models.Model):
    _name = "document.log.details.report"
    _description = "Document Log Details Report"
    _auto = False
    ...
    def _get_html(self):
        ...
        if report:
            ...
            result["html"] = self.env['ir.qweb']._render(
                "document_log_report.document_log_details_report", rcontext)
        return result

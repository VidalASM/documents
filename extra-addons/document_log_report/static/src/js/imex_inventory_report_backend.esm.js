...
export const document_log_report_backend = AbstractAction.extend({
    hasControlPanel: true,
    // Stores all the parameters of the action.
    events: {
        "click .o_document_log_reports_print": "print",
    },
...
core.action_registry.add("document_log_report_backend", document_log_report_backend);
